...
_gen_bands = product('ugriz', '123456')
_filt_url = 'http://www.ioa.s.u-tokyo.ac.jp/~doi/sdss/'
_local_filt_file_names = [f'{band}{column}.dat' for band, column in _gen_bands]
download_data(
    base_url=_filt_url,
    out_dir=filter_dir,
...
band_names = [f'91bg_proj_sdss_{band}{column}' for band, column in _gen_bands]
