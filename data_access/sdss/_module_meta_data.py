...
outlier_path = os.path.join(snana_dir, 'SDSS_allCandidates+BOSS/SDSS_allCandidates+BOSS.IGNORE')  # Outlier photometric data
...
_local_filt_file_names = [f'{band}{column}.dat' for band, column in product('ugriz', '123456')]
download_data(
    base_url=_filt_url,
    out_dir=filter_dir,
...
band_names = [f'91bg_proj_sdss_{band}{column}' for band, column in product('ugriz', '123456')]
